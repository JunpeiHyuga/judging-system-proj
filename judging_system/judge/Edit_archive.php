...
";
                ...
                <td>
                <button class="btn btn-primary"><a href="Update.php?id=' . $rank_id . '" class="text-light"><i class="fa fa-pencil"></i></a></button>
                        <button class="btn btn-danger"><a href="delete.php?deleteid=' . $rank_id . '" class="text-light"><i class="fa fa-trash"></i></a></button>
                </td>
              </tr>';
                      }
                    }
