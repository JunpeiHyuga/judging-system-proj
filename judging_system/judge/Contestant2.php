        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="flex-grow-1">
              ...
              $sql = "SELECT `total_score` FROM `ranking_system` WHERE `archive` = 0 LIMIT 0, 2";  // adjust the query based on your table structure and requirements
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item"><a class="nav-link active" href="../judge/Contestant2.php">Contestant 102</a></li>
