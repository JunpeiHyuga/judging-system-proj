      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">My /</span> Profile</h4>
            <div class="container">
              <div class="card mt-5">
            ...
            LIMIT 0, 1";
                    ...
                    $sql = "SELECT `first_name`, `middle_name`, `surname`, `email_username`, `password`, `picture` FROM `organizer` WHERE `account_type` = 'Judge' LIMIT 0, 1";
                    $result = mysqli_query($CONNECTION, $sql);
                    $row = mysqli_fetch_assoc($result);
                    if ($row) {
                  ...
                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="../judge/Judge_dashboard.php" class="btn btn-secondary" data-dismiss="modal" style="margin-right: 10px;">Cancel</a>
