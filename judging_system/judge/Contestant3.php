    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <!-- Content -->
          <?php
          // Establish database connection (ensure $CONNECTION is defined)


          // Fetch all contestants (modify as per your requirement, e.g., based on user input)
          $query_fetch_contestants = "SELECT `contestant_id`, `contestant_fullname`, `contestant_no`, `contestant_address`, `archived` FROM `add_contestant` LIMIT 0, 3";
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <?php
              ...
              $sql = "SELECT `total_score` FROM `ranking_system` WHERE `archive` = 0 LIMIT 0, 3";  // adjust the query based on your table structure and requirements
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item"><a class="nav-link active" href="../judge/Contestant3.php">Contestant 103</a></li>
