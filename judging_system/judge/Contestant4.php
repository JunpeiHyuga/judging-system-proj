                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-medium d-block">
                            <?php
                            $sql = "SELECT `first_name` FROM `organizer` WHERE`account_type` = 'Judge'";
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <?php
              ...
              $sql = "SELECT `total_score` FROM `ranking_system` WHERE `archive` = 0 LIMIT 0, 4";  // adjust the query based on your table structure and requirements
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item"><a class="nav-link active" href="../judge/Contestant4.php">Contestant 104</a></li>
