...
<body>
  ...
  height: auto;">
            ...
            if (isset($_POST["submit"])) {
              ...
              $student_query = "SELECT * FROM `add_guest` WHERE `username` = ?";
              ...
              if (mysqli_num_rows($result_query) > 0) {
                ...
                $query = "INSERT INTO `add_guest`(`username`, `email`, `password`) VALUES (?, ?, ?)";
            ...
            <form id="formAuthentication" class="mb-3" action="" method="post">
              ...
              <div class="mb-3">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="terms-conditions" name="agree" />
