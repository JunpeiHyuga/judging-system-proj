              ...
              <div class="table-responsive text-nowrap">
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <?php
                    $sql = "SELECT `judges_id`, `fullname`, `judges`, `email`, `phone` FROM `add_judges`";
                    ...
                    if ($RESULTS = mysqli_query($CONNECTION, $sql)) {
                      while ($row = mysqli_fetch_array($RESULTS)) {
                        ...
                        echo '<tr>
                              ...
                              <td>' . $phone . '</td>
                              <td>
                        <button class="btn btn-primary"><a href="Update_edit_archive.php?id=' . $id . '" class="text-light"><i class="fa fa-pencil"></i></a></button>
                        <button class="btn btn-danger"><a href="delete.php?deleteid=' . $id . '" class="text-light"><i class="fa fa-trash"></i></a></button>
                              </td>
                              </tr>';
                      }
                    }
