              ...
              <div class="table-responsive text-nowrap">
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <?php
                    $sql = "SELECT `event_id`, `event_name`, `school_year`, `date_start`, `date_end`, `venue`, `time_start`, `end_time`, `status` FROM `add_events`";
                    ...
                    if ($RESULTS = mysqli_query($CONNECTION, $sql)) {
                      while ($row = mysqli_fetch_array($RESULTS)) {
                        ...
                        echo '<tr>
                              ...
                              <td>' . $status . '</td>
                              <td>
                        <button class="btn btn-primary"><a href="..\admin\Update_event_status.php?id=' . $event_id . '" class="text-light"><i class="fa fa-pencil"></i></a></button>
                        <button class="btn btn-danger" data-target="#confirmModal"><a href="..\admin\Delete.php?id=' . $event_id . '" class="text-light"><i class="fa fa-archive"></i></a></button>
