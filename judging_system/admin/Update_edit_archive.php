    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <h4 class="py-3 mb-4"><span class="text-muted fw-light">Edit/</span> Judge</h4>
            <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit/ Judge</h5>
                  ...
                  <div class="card-body">
                    ...
                    if ($id) {
                      $query = "SELECT * FROM add_judges WHERE judges_id = ?";
                    ...
                    <input type="hidden" name="id" value="<?php echo isset($id) ? $id : ''; ?>">
                      <div class="mb-3">
                        <label class="form-label" for="basic-icon-default-fullname">Fullname: </label>
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-list-plus"></i></span>
                          <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Fullname" aria-label="fullname" aria-describedby="basic-icon-default-fullname2" name="fullname" value="<?php echo isset($fullname) ? $fullname : ''; ?>" />
                        </div>
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="basic-icon-default-company">Judge: </label>
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-company2" class="input-group-text"><i class="bx bx-group"></i></span>
                          <input type="text" id="basic-icon-default-company" class="form-control" placeholder="Judge" aria-label="yyyy - yyyy" aria-describedby="basic-icon-default-company2" name="judges" value="<?php echo isset($judges) ? $judges : ''; ?>" />
                        </div>
                      </div>
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" id="basic-icon-default-company" class="form-control" placeholder="email" aria-label="yyyy - yyyy" aria-describedby="basic-icon-default-company2" name="email" value="<?php echo isset($email) ? $email : ''; ?>" />
                        </div>
                      </div>
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" id="basic-icon-default-company" class="form-control" placeholder="Phone" aria-label="yyyy - yyyy" aria-describedby="basic-icon-default-company2" name="phone" value="<?php echo isset($phone) ? $phone : ''; ?>" />
                        </div>
                      </div>
                  </div>
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['id']) && !empty($_POST['id'])) {
        $id = $_POST['id'];
        $sqlquery = "UPDATE add_judges SET fullname = ?, judges = ?, email = ?, phone = ? WHERE judges_id = ?";
        $stmt = mysqli_prepare($CONNECTION, $sqlquery);
        mysqli_stmt_bind_param($stmt, 'ssssi', $fullname, $judges, $email, $phone, $id);
    } else {
        // If no ID, perform an insert
        $sqlquery = "INSERT INTO add_judges (fullname, judges, email, phone) VALUES (?, ?, ?, ?)";
        $stmt = mysqli_prepare($CONNECTION, $sqlquery);
        mysqli_stmt_bind_param($stmt, 'ssss', $fullname, $judges, $email, $phone);
    }
    ...
    if (mysqli_stmt_execute($stmt)) {
      ...
      $(document).ready(function() {
        ...
        $('#successModal').modal('show');
        window.location = '../admin/Edit_archive.php'; // Redirect to dashboard or appropriate page
      });
    </script>";
    } else {
